...
Route::group(['prefix'=>'dinhdangphim','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'ghe','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'khuyenmai','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'loaiphim','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'loaiphimphim','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'phanhoi','middleware'=>'loginadmin'], function(){
    Route::get('/danhsach', [App\Http\Controllers\PhanHoiController::class, 'getDanhSach'])->name('phanhoi.danhsach');
    Route::get('/them', [App\Http\Controllers\PhanHoiController::class, 'getThem'])->name('phanhoi.them');
    Route::post('/them', [App\Http\Controllers\PhanHoiController::class, 'postThem'])->name('phanhoi.them');
...
Route::group(['prefix'=>'phim','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'phong','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'quanhuyen','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'rap','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'suatchieu','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'thanhpho','middleware'=>'loginadmin'], function(){
...
Route::group(['prefix'=>'ve','middleware'=>'loginadmin'], function(){
